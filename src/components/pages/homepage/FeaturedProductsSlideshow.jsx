    ...
    return (
        <div className={styles.FeaturedProductsSlideshow}>
            ...
            <div className={styles.Slideshow}>
                <div className={styles.ArrowContainer} onClick={() => dispatch(moveFeaturedProducts("left"))}><ArrowLeftIcon /></div>
                ...
                <div className={styles.ArrowContainer} onClick={() => dispatch(moveFeaturedProducts("right"))}><ArrowRightIcon /></div>
            </div>
        </div>
    )
}
